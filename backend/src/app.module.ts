...
import { SysStockModule } from './modules/sys_stock/sys_stock.module'
import { SysUserModule } from './modules/sys_user/sys_user.module'
import { SharedModule } from './shared/shared.module'

@Module({
  imports: [SharedModule, SysAuthModule, SysUserModule, SysRoleModule, SysDeptModule, SysGoodsModule, SysStockModule],
  controllers: [],
  providers: [],
})
